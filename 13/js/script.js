...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _canvas_animate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas-animate.js */ "./source/js/modules/canvas-animate.js");
  ...
  document.querySelectorAll(`.game__button`).forEach((button) => {
    button.addEventListener(`click`, () => {
      if (button.dataset.target === `result`) {
        const winCanvasAnim = new _canvas_animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
        winCanvasAnim.start();
      }
    });
  });
